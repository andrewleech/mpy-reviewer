...
Claude: ● /mpy-review
I'll review your current branch using historical review patterns.
[runs: git diff main | mpy-reviewer review --stdin --codebase --output prompt]
[provides maintainer-style review feedback]
```
...
[runs: git show ca65d543 | mpy-reviewer review --stdin --codebase --output prompt]
...
[runs: git diff main -- py/gc.c | mpy-reviewer review --stdin --output prompt]
[provides targeted review for that file]
```

### Find Review Examples
```
You: What has the lead maintainer said about memory allocation?

Claude: ● /mpy-review
I'll search for historical feedback on memory allocation.
[runs: mpy-reviewer search "memory allocation" --domain memory -k 10]
...
- "What would the lead maintainer think of my changes?"
- "Can you give me feedback on my code?"

**For Examples:**
- "Find examples of GPIO reviews"
- "Show me what the lead maintainer has said about error handling"
...
3. **Ask for examples** - "What has the lead maintainer said about..." gets relevant patterns
...
| Find patterns | "What has the lead maintainer said about memory leaks?" |
