...
def build_system_prompt(
    ...
    tool_instructions = (
        ...
        "\n"
        "Collect ALL your inline comments into a JSON array before calling "
        "`post_review`. Each comment object must have:\n"
        ...
        "```json\n"
        "[\n"
        "  {\"path\": \"py/gc.c\", \"line\": 42, \"side\": \"RIGHT\", "
        "\"body\": \"Missing null check.\"},\n"
        "  {\"path\": \"py/obj.h\", \"line\": 10, \"side\": \"RIGHT\", "
        "\"body\": \"please use `void` in arg list\"}\n"
        "]\n"
        "```\n"
        "\n"
